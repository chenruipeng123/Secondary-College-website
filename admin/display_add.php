...
if (!empty($_POST['show_order']) && !empty($_POST['title'])) {
    if (isset($_GET['a']) && $_GET['a'] == 'add') {
        ...
        $mes = $mysqlObj->insert("display", $ins_menu);
        if ($mes) {
            alertMes("添加成功", "display.php");
        }
    }
}
				...
				<div class="col-sm-12">
					<div class="tabbable">
						...
						<div class="tab-content">
							<div class="row">
								<div class="col-xs-12">
									<form action="display_add.php?a=add" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
