									...
									<?php 
									 ...
									 ?>
										<tr>
											...
											<td><img src="../uploads/<?php echo $info['img']?>" alt="" width=50></td>
											<td><?php 
												if ($info['state']==1) {
											...
											<td><a href="pic_edit.php?id=<?php echo $_GET['id'] ?>&up_id=<?php echo $_GET['up_id'] ?>&mid=<?php echo $info['id'] ?>">编辑</a>&nbsp;
												<a class="red delete-btn" href="pic.php?id=<?php echo $info['up_id'] ?>&up_id=<?php echo $_GET['up_id'] ?>&cid=<?php echo $info['id'] ?>&a=del" onclick="return del()">&nbsp;
													删除
												</a>&nbsp;
												<?php
													if ($info['toutiao'] == 0) {
						...
						<?php 
							if (isset($_GET['a'])&&$_GET['a']=='del') {
								...
								if ($mes) {
									...
									alertMes("删除失败","pic.php?id={$_GET['id']}&up_id={$_GET['up_id']}");
									exit;
								}
							}
						 ?>
